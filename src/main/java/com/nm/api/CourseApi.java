...
public class CourseApi {
	...
	public ResponseEntity<Course> updateCourse(   @PathVariable Long id,
			 @RequestPart("course") Course course,@RequestPart(value="imageFile",required = false)MultipartFile imageFile){
		try {
			return courseService.updateCourse(id, course, imageFile)
